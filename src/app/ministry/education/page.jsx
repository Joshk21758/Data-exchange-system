...
export default async function MinistryOfEducationPage() {
  //get education collection
  const educationCollection = await getCollection("education-collection");
  const posts = await educationCollection
    .find()
    .sort({ $natural: -1 })
    .toArray();
    ...
    <div className="grid flex-1 items-start gap-4 md:gap-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review and manage data requests for this ministry.
          </CardDescription>
          <CardContent>
            <Table>
              <TableHeader>
