export const dashboardStats = [
    { title: "Pending Applications", value: "12", change: "+12.5%", changeType: "increase", icon: "FileText" },
    { title: "Data Requests", value: "8", change: "-5.2%", changeType: "decrease", icon: "ArrowRightLeft" },
    { title: "Approved Documents", value: "245", change: "+20.1%", changeType: "increase", icon: "CheckCircle" },
    { title: "Security Alerts", value: "3", change: "+300%", changeType: "increase", icon: "ShieldAlert" },
];
